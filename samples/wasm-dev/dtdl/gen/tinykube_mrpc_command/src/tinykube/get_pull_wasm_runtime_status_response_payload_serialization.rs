...
impl PayloadSerialize for GetPullWasmRuntimeStatusResponsePayload {
...
const RAW_SCHEMA: &str = r#"
{
  ...
  "name": "GetPullWasmRuntimeStatusResponsePayload",
  "type": "record",
  "fields": [
    {
      "name": "rspParams",
      "type": {
"name": "GetPullWasmRuntimeStatusResponseSchema",
"type": "record",
"fields": [
  {
...
"type": [
  "null",
  {
"name": "RuntimeUpdateStatusSchema",
"type": "enum",
"symbols": [ "downloading", "downloaded", "failed" ]
  }
]
  },
  {
