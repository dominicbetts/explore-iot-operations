...
use super::get_pull_module_status_request_payload::GetPullModuleStatusRequestPayload;
use super::get_pull_module_status_response_payload::GetPullModuleStatusResponsePayload;
use super::MODEL_ID;
use super::REQUEST_TOPIC_PATTERN;

pub type GetPullModuleStatusRequest = CommandRequest<GetPullModuleStatusRequestPayload>;
pub type GetPullModuleStatusResponse = CommandResponse<GetPullModuleStatusResponsePayload>;
pub type GetPullModuleStatusRequestBuilderError = CommandRequestBuilderError;

#[derive(Default)]
/// Builder for [`GetPullModuleStatusRequest`]
pub struct GetPullModuleStatusRequestBuilder {
    inner_builder: CommandRequestBuilder<GetPullModuleStatusRequestPayload>,
    set_executor_id: bool,
}

impl GetPullModuleStatusRequestBuilder {
    ...
    pub fn payload(
        &mut self,
        payload: GetPullModuleStatusRequestPayload,
    ) -> Result<&mut Self, AIOProtocolError> {
        self.inner_builder.payload(payload)?;
        Ok(self)
    }

    /// Builds a new `GetPullModuleStatusRequest`
    ///
    /// # Errors
    ...
    pub fn build(
        &mut self,
    ) -> Result<GetPullModuleStatusRequest, GetPullModuleStatusRequestBuilderError> {
        if !self.set_executor_id {
            return Err(GetPullModuleStatusRequestBuilderError::UninitializedField(
                "executor_id",
            ));
        }
...
/// Command Invoker for `getPullModuleStatus`
pub struct GetPullModuleStatusCommandInvoker<C>(
    CommandInvoker<GetPullModuleStatusRequestPayload, GetPullModuleStatusResponsePayload, C>,
)
where
    C: ManagedClient + Clone + Send + Sync + 'static,
    C::PubReceiver: Send + Sync + 'static;

impl<C> GetPullModuleStatusCommandInvoker<C>
where
    C: ManagedClient + Clone + Send + Sync + 'static,
    C::PubReceiver: Send + Sync + 'static,
{
    /// Creates a new [`GetPullModuleStatusCommandInvoker`]
    ///
    /// # Panics
    ...
    pub fn new(
        ...
        topic_token_map.insert("commandName".to_string(), "getPullModuleStatus".to_string());

        let invoker_options = invoker_options_builder
            .request_topic_pattern(REQUEST_TOPIC_PATTERN)
            .command_name("getPullModuleStatus")
    ...
    /// Invokes the [`GetPullModuleStatusRequest`]
    ///
    /// # Errors
    /// [`AIOProtocolError`] if there is a failure invoking the request
    pub async fn invoke(
        &self,
        request: GetPullModuleStatusRequest,
    ) -> Result<GetPullModuleStatusResponse, AIOProtocolError> {
        self.0.invoke(request).await
    }

    /// Shutdown the [`GetPullModuleStatusCommandInvoker`]. Unsubscribes from the response topic and cancels the receiver loop to drop the receiver and to prevent the task from looping indefinitely.
    ///
