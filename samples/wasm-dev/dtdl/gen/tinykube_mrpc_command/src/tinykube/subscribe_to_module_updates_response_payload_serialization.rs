...
impl PayloadSerialize for SubscribeToModuleUpdatesResponsePayload {
...
const RAW_SCHEMA: &str = r#"
{
  ...
  "name": "SubscribeToModuleUpdatesResponsePayload",
  "type": "record",
  "fields": [
    {
      "name": "rspParams",
      "type": {
"name": "SubscribeToModuleUpdatesResponseSchema",
"type": "record",
"fields": [
  {
    "name": "statusCode",
