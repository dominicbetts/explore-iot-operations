...
impl PayloadSerialize for GetPullModuleStatusResponsePayload {
...
const RAW_SCHEMA: &str = r#"
{
  ...
  "name": "GetPullModuleStatusResponsePayload",
  "type": "record",
  "fields": [
    {
      "name": "rspParams",
      "type": {
"name": "GetPullModuleStatusResponseSchema",
"type": "record",
"fields": [
  {
