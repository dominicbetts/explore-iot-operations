...
impl PayloadSerialize for GetModuleStatusResponsePayload {
...
const RAW_SCHEMA: &str = r#"
{
  ...
  "name": "GetModuleStatusResponsePayload",
  "type": "record",
  "fields": [
    {
      "name": "rspParams",
...
"type": "array",
"items": {
"name": "GetModuleStatusResponseSchemaElementSchema",
"type": "record",
"fields": [
  {
    "name": "wasmModuleId",
...
"type": [
  "null",
  {
"name": "WasmModuleStatusSchema",
"type": "enum",
"symbols": [ "running", "stopped", "noexist" ]
  }
]
  },
  {
