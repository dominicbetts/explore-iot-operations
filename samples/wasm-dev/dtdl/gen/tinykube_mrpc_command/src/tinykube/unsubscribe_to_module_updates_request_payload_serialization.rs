...
impl PayloadSerialize for UnsubscribeToModuleUpdatesRequestPayload {
...
const RAW_SCHEMA: &str = r#"
{
  ...
  "name": "UnsubscribeToModuleUpdatesRequestPayload",
  "type": "record",
  "fields": [
    {
      "name": "reqParams",
      "type": {
"name": "UnsubscribeToModuleUpdatesRequestSchema",
"type": "record",
"fields": [
  {
    "name": "appId",
