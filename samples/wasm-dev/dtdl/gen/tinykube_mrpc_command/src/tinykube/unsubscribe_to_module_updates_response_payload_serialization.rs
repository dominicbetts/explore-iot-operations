...
impl PayloadSerialize for UnsubscribeToModuleUpdatesResponsePayload {
...
const RAW_SCHEMA: &str = r#"
{
  ...
  "name": "UnsubscribeToModuleUpdatesResponsePayload",
  "type": "record",
  "fields": [
    {
      "name": "rspParams",
      "type": {
"name": "UnsubscribeToModuleUpdatesResponseSchema",
"type": "record",
"fields": [
  {
    "name": "statusCode",
